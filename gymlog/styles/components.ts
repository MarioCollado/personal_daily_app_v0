...
export const input = {
  ...
  center: 'bg-surface-2 border border-surface-border rounded-xl px-3 py-2.5 text-white placeholder-zinc-500 focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500/30 transition-colors duration-100 w-full text-center text-sm sm:text-base',
...
export const text = {
  ...
  caption:      'text-xs sm:text-sm text-zinc-500',
  captionMono:  'text-xs text-zinc-500 font-mono',
  sectionTitle: 'font-semibold text-sm sm:text-base text-zinc-400 mb-3 flex items-center gap-2',
  pageTitle:    'font-bold text-base sm:text-lg',
...
export const cardio = {
  ...
  paceUnit:    'text-xs text-zinc-500',
